...
class _LecturerHomeScreenState extends ConsumerState<LecturerHomeScreen> {
  ...
  void _handleDoubleTap() {
    ...
    if (_lastTapTime != null &&
      ...
      ref.read(homePreferencesProvider.notifier).togglePreference('showClassStats');
      Toast.show(
        context,
        ...
        child: RefreshableListView(
          ...
          child: Column(
            ...
            children: [
              ...
              // Lecturer-specific Statistics Section with animation
                            ...
                            children: [
                              ...
                              IconButton(
                                ...
                                onPressed: () {
                                  ...
                                  Toast.show(
                                    context,
                                    message: 'Class statistics hidden',
                                    type: ToastType.info,
                                  );
                                },
                              ),
                    ...
                    error: (error, stackTrace) {
                      ...
                      return Center(
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            const Text('Failed to load class statistics'),
                            SizedBox(height: AppConstants.defaultSpacing),
                            ElevatedButton(
                              onPressed: () {
                                ref.invalidate(dashboardStatsProvider);
                                Toast.show(
                                  context,
                                  message: 'Retrying to load class statistics...',
                                  type: ToastType.info,
                                );
                              },
                              child: const Text('Retry'),
