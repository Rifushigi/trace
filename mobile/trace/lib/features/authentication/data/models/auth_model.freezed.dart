...
class _$AuthModelImpl implements _AuthModel {
  ...
  @override
  String toString() {
    return 'AuthModel(id: $id, email: $email, role: $role, isVerified: $isVerified, firstName: $firstName, lastName: $lastName, staffId: $staffId, college: $college)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, email, role, isVerified,
      firstName, lastName, staffId, college);
...
abstract class _AuthModel implements AuthModel {
  const factory _AuthModel(
      ...
      final String? lastName,
      final String? staffId,
      final String? college}) = _$AuthModelImpl;
