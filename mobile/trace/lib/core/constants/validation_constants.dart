...
class ValidationConstants {
  ...
  static const String invalidMatricNumber = 'Please enter a valid matric number (e.g., BU20CSC1001)';
  static const String invalidStaffId = 'Please enter a valid staff ID (e.g., CS123456)';
